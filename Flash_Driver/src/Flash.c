...
#define OPT_3_WRP0_WRP1                     0x1FFFF808			/*write protection bytes*/
#define OPT_4_WRP2_WRP3                     0x1FFFF80C			/*write protection bytes*/
 ...
 * Then updating them and reloading them again to their flash addresses*/
