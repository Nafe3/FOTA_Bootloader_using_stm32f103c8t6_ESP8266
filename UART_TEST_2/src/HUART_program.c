...
#pragma GCC diagnostic ignored "-Wreturn-type"
 ...
 const UART_GPIO_t HUART_USART1 = {
		.TX = {PORTA, GPIO_PIN_9 , GPIO_MODE_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL, GPIO_OUTPUT_SPEED_50MHz},
		.RX = {PORTA, GPIO_PIN_10, GPIO_MODE_INPUT_PULLUP_PULLDOWN , GPIO_OUTPUT_SPEED_50MHz},
 ...
 const UART_GPIO_t HUART_USART2 = {
 		.TX = {PORTA, GPIO_PIN_2, GPIO_MODE_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL, GPIO_OUTPUT_SPEED_50MHz},
 		.RX = {PORTA, GPIO_PIN_3, GPIO_MODE_INPUT_PULLUP_PULLDOWN , GPIO_OUTPUT_SPEED_50MHz},
 		.Port = RCC_PERIPHERALS_PORTA,
 ...
 const UART_GPIO_t HUART_USART3 = {
 		.TX = {PORTB, GPIO_PIN_10, GPIO_MODE_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL, GPIO_OUTPUT_SPEED_50MHz},
 		.RX = {PORTB, GPIO_PIN_11,GPIO_MODE_INPUT_PULLUP_PULLDOWN , GPIO_OUTPUT_SPEED_50MHz},
